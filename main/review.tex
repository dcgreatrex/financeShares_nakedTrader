...
\paragraph{Level 2}
Level 2 data provides full details of the current bid and offer price as well as prices that exist at other levels and offers of individual market makers.
The naked trader always uses level 2 data for timing entry or exit from the market and would not trade without it.
With level 2 you can see the market makers begin to move their prices before it makes a difference to the level 1 prices (current bid ask).
This allows you to buy and sell before the crowd knows there is going to be a price change.
When you see a lot of market makers moving up it is a good sign.

With bigger stocks you can also see buy and sell orders from all of the exchanges.
Seeing how big the buy orders and sell orders are you can judge where support might be.
This is important as it will stop you from selling out when the support does not justify a large downwards move.

Some providers offer you Direct Market Access (DMA). 
Basically, this allows you to be the market maker by allowing you to input directly onto the order book.

\paragraph{Spread betting}
Spread betting provides another way of betting on the market. 
Rather than owning shares you enter into contracts with a spread betting firm.
These allow you to bet on both upwards and downwards price movements in companies, indices and commodities.
Spread bets do not cost to open, however the spread is wider than normal share trading. 
On opening a position you state whether the instrument will go up or down, the price for each movement point and select an expiry date.
Spread bets are also tax-free as they are classified as a form of gambling.
The naked trader primarily uses spread bets for shorting indices and gaining exposure to small cap shares when the ISA limit is reached.
It is recommended reading "The Naked Traders Guide to Spread Betting" as spread betting is a topic in its own right.

\paragraph{Shorting}:
Shorting allows you to make money if a stock goes down.
The naked trader usually has at least two short positions open. 
There are various ways to short a stock: 
\begin{enumerate*}
\item CDFs
\item Covered warrants
\item Spread betting
\end{enumerate*}
You can use shorting to hedge a position.
This is when you hold stock in a company, but short the stock by an equivalent value when there is short term volatility. 

The naked trader looks for the following features when finding a company to short:
\begin{enumerate*}
\item Profit warnings
\item General downturns - i.e. when a share keeps going down, perhaps breaking through 52-week lows.
\item High P/E 
\item Descriptive words such as "challenging", "difficulties" or "Problems".
\item Shares that demonstrate break down patterns and move below well defined support levels.
\item Big debt.
\item Companies in non favourable sectors.
\end{enumerate*}

When looking to short, do not do the following:
\begin{enumerate*}
\item Go against the trend.
\item Short a share because a famous hedge fund manager has - he or she is probably in at better price and may be wrong. 
\item Short shares in a strong rising market.
\item Short shares for a long time.
\end{enumerate*}
Remember that indices like the FTSE and Dow can move very fast so be careful when shorting and watch your positions.

\paragraph{Other instruments:}
\begin{enumerate*}
\item Contract for difference (CDFs): Instead of buying shares CDFs allow you to buy a contract with a bookmaker that represents a share or index price.
The difference to buying shares is that you can (i) short instruments without owning shares, (ii) Avoid paying stamp duty however you will be required to pay a daily interest fee.
The interest fee is usually around 70p a day for a £5K position. 
CDFs should be avoided by beginners as you can easily over trade and take on too much leverage. 
Six months should be the maximum holding time for a CDF.
\item Cover warrants: These are complex derivatives that are useful for shorting. 
Look else where if you require more information about them.
\item Investment trusts: Funds that buy shares in other companies.
These are useful as they provide exposure to a sector or investment theme and are managed by a fund manager who has knowledge of the investment area.
The naked trader recommends RIT and TEMIT as good funds that he has made money from in the past.
Investment trusts rise and fall in line with their net asset value (NAV).
This is a rough calculation of the value of the fund at points in time, updated either monthly, weekly or daily.
\end{enumerate*}

%------------------------------------------------
\section*{Section 6 - Trading in real life}
This chapter is all about learning from the mistakes of others.

\subsection*{Top 20 mistakes:}
\begin{itemize}
\item Not using a stop loss: When the trade turns against you have the balls to get out and take your loss.
\item Setting stop losses too tight: If the stop is too close the the current price you will likely get stopped out in the morning on wide spread.
Use levels below resistance and support to make sure you do not get stopped out too early.
\item Gambling by investing in bad penny shares (wanting the "ten bagger").
\item Buying companies with big debt.
Funders can pull the plug on companies with large debt to profit ratio with results in you loosing all of your shares and investment.
Do not buy companies in which the debt is more than three times the most recent full year pre-tax profit.
\item Buying tipped shares: Market makers will inflate the price of tipped small caps before market open.
They will then try to scare you into selling, effectively selling them to you at a high price and buying them back off you at a low price.
Do you own research before buying any share.
\item Selling you shares on the ex-dividend date: There might be a valid reason for why a share price goes down quickly, check this before selling.
\item Ignoring profit warnings/negatives: Why take the risk of buying or owning a share that has just issued a profit warning.
Likewise, if you notice negatives being published in company statements do not hang around!
There are better investments elsewhere. 
\item Overtrading / smugness / greed: Gamblers fallacy, just because you are winning does not mean you are the master of the universe!
Do not be tempted to change your tactics based on winning streaks and avoid overtrading. 
\end{itemize}
...
\item https://www.amazon.co.uk/Naked-Traders-Guide-Spread-Betting/dp/1906659230
\end{itemize}
